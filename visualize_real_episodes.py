...
def main(args):
    ...
    is_mobile = "mobile" in dataset_dir
    if is_mobile:
        qpos, qvel, effort, action, base_action, image_dict = load_hdf5(dataset_dir, dataset_name, is_mobile)
    else:
        qpos, qvel, effort, action, image_dict = load_hdf5(dataset_dir, dataset_name, is_mobile)
    print('hdf5 loaded!!')
